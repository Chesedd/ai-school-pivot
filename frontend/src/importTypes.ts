export const IMPORT_HEADERS=["subject_code","grade_number","topic_code","subtopic_code","title","statement","task_type","answer_format","difficulty","source","primary_skill_code","primary_skill_weight","additional_skills","tags"] as const;
export const REQUIRED_IMPORT_HEADERS=IMPORT_HEADERS.filter(h=>h!=="tags");
export type ImportHeader=typeof IMPORT_HEADERS[number];
export type LocalIssueCode="invalid_tag_cell"|"tag_name_invalid"|"tag_limit_exceeded"|"unsupported_file_type"|"file_too_large"|"invalid_utf8"|"missing_tasks_sheet"|"duplicate_tasks_sheet"|"missing_header"|"unknown_header"|"duplicate_header"|"empty_file"|"too_many_rows"|"invalid_grade"|"invalid_enum"|"invalid_weight"|"invalid_skills_syntax"|"duplicate_skill"|"catalog_reference_not_found"|"catalog_hierarchy_mismatch";
