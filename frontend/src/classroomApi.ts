...
export const getClassStudent=(classId:string,studentId:string,signal?:AbortSignal):Promise<TeacherStudent>=>request(`/api/classrooms/${enc(classId)}/students/${enc(studentId)}`,{signal});
