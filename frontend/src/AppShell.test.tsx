...
describe("Content Bank application shell",()=>{
 ...
 it("does not expose import navigation or the removed direct route",()=>{history.replaceState({},"","/content-bank/import");render(<App/>);expect(screen.queryByRole("link",{name:"Импорт"})).toBeNull();expect(screen.getByRole("heading",{name:"Страница не найдена"})).toBeTruthy()});
