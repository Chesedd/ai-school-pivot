...
> **Статус на 2026-07-30:** архитектура спроектирована, но **не реализована**.
> Этот contract-first документ является единственным выбранным контрактом для
> следующих backend- и frontend-фаз. В текущей системе задания по-прежнему
> показываются плоским списком. Миграции, runtime-кода и UI папок в этой фазе нет.
