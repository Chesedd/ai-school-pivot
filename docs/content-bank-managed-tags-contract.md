...
Статус документа: обязательный технический контракт будущей реализации. Он описывает
целевое поведение, но **не утверждает, что теги уже реализованы**. Базовая revision для
будущей миграции — `20260806_01`.
